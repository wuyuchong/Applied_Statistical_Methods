...
- For every one unit increase in the PoInt, increases by `r m$coefficients[2]`, holding other variables constant.
- For every one unit increase in being a member of the Trade Union,  decreases by `r m$coefficients[3]`, holding other variables constant.
- For every one unit increase in family size, decreases by `r m$coefficients[4]`, holding other variables constant.
