...
- If $\epsilon_A$ and $\epsilon_B$ follows an normal distribution, then $\epsilon = (\epsilon_A-\epsilon_B )$
follows a normal distribution, then we will get the probit model.
- If $\epsilon_A$ and $\epsilon_B$ follows an extreme value distribution, then $\epsilon = (\epsilon_A-\epsilon_B)$
