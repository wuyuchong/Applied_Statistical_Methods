...
1. The result part is blank - fixed, removed result
2. The name for the coefficient tables are wrong. 
3. The coefficient table for PROBIT is wrong at the area category. - fixed
4. Put the coefficient tables into the interpretation part of the presentation.
5. Put the selected variables tables into the dataset part of the presentation.
6. Change the layout of the presentation. We just need one vertical section for each person. Thus, there should be 3 columns except the first slide in total.
